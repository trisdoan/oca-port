...
class App(Output):
    ...
    def run_analyze(self):
        self._print(
            f"Analyzing {bc.BOLD}{self.addon}{bc.END} "
            f"from {bc.BOLD}{self.source.ref}{bc.END} "
            f"to {bc.BOLD}{self.target.ref}{bc.END}"
        )
    ...
    def run_heatmap(self):
        ...
        return AnalyzeNativeChanges(self).get_heatmap_data()
