...
class TestApp(common.CommonCase):
    def test_app_init(self):
        ...
        self.assertEqual(app.target.org, None)
        self.assertEqual(app.target.branch, "16.0")
        self.assertEqual(app.destination.org, None)
        self.assertEqual(app.destination.remote, None)
        self.assertEqual(app.destination.branch, None)
        self.assertEqual(app.destination.branch, None)
